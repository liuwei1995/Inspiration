...
public abstract class HealthyPopupWindow extends PopupWindow implements View.OnClickListener{

    protected  View mContentView;

    public HealthyPopupWindow(Context context,View contentView) {
        super(context);
    ...
    public HealthyPopupWindow(Context context,@LayoutRes int itemLayoutId){

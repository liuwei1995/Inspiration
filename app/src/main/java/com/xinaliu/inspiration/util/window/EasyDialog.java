 ...
 * 要你命3000
 *
 * <li>easydialog_layout_dialog.xml</li>
 */
public class EasyDialog
{
    ...
    private void initDialog(final Context context)
    {
        ...
        View dialogView = layoutInflater.inflate(R.layout.easydialog_layout_dialog, null);
...
//        dialog = new Dialog(context, isFullScreen() ? android.R.style.Theme_Translucent_NoTitleBar_Fullscreen : android.R.style.Theme_Translucent_NoTitleBar);
        dialog = new Dialog(context, R.style.Theme_Translucent_TitleBar);
     ...
     * 设置提示框中要显示的内容
     */
    public EasyDialog setLayout(View layout,OnChangeView mOnChangeView){
        if (layout != null)
        {
            if (mOnChangeView != null){
                mOnChangeView.changeContentView(new ViewHolder(layout),this);
            }
    ...
    {
        return setLayout(layout,null);
    }

    /**
     * 设置提示框中要显示的内容的布局Id
     */
    public EasyDialog setLayoutResourceId(@LayoutRes int layoutResourceId,OnChangeView mOnChangeView)
    {
        View view = ((Activity) context).getLayoutInflater().inflate(layoutResourceId, null);
        if (mOnChangeView != null){
            mOnChangeView.changeContentView(new ViewHolder(view),this);
        }
        setLayout(view);
        return this;
    }
    public EasyDialog setLayoutResourceId(@LayoutRes int layoutResourceId)
    {
        return setLayoutResourceId(layoutResourceId,null);
    }
    ...
    public EasyDialog setGravity(int gravity)
    {
        ...
        {
            case GRAVITY_BOTTOM:
                ivTriangle.setBackgroundResource(R.drawable.easydialog_triangle_bottom);
                break;
            case GRAVITY_TOP:
                ivTriangle.setBackgroundResource(R.drawable.easydialog_triangle_top);
                break;
        }
        llContent.setBackgroundResource(R.drawable.easydialog_round_corner_bg);
     ...
     */
    public EasyDialog setBackgroundColor(@ColorInt int color)
    {
...
//        ObjectAnimator.ofFloat(rlOutsideBackground.findViewById(R.id.rlParentForAnimate), "scaleY", 0.3f, 1.0f).setDuration(500).start();
    ...
    public interface OnChangeView{
        ...
        void changeContentView(ViewHolder holder, final EasyDialog easyDialog);
    ...
    public class ViewHolder implements View.OnClickListener{
        ...
        public void setText(int id,@StringRes int resid){
            TextView tv = getView(id);
            if (tv != null){
                tv.setText(resid);
            }
